...
def print_index(index, name):
    ...
    print(name, index['regularMarketPrice'],
          colored_change, '| dropdown=false', sep=' ')
...
def print_stock(s):
    ...
    two_hundred_day_change = '(' + '{:.2f}'.format(
        s['twoHundredDayAverageChangePercent'] * 100) + '%)'
    ...
    print('--' + s['fullExchangeName'] +
          ' - Currency in ' + s['currency'] + FONT)
    ...
    print(stock_submenu.format('--200 MA:',
          two_hundred_day + ' ' + two_hundred_day_change))

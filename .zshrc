...
alias codex='/Users/kazuph/.local/share/mise/installs/node/22.18.0/bin/codex --sandbox workspace-write --config sandbox_workspace_write.network_access=true --dangerously-bypass-approvals-and-sandbox'
